...
//            new CheckAccount(view.getContext()).execute(account);

            if(account.getLogin().equals(USER_LOGIN) && account.getPassword().equals(USER_PASSWORD)){
                startActivity(HelloActivity.newIntent(view.getContext(),account.getLogin()));
            }
